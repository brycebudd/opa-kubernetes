...
import data.volumes.allowed_volumes_match_containers.violations
...
test_should_not_allow_volumes_without_container_mount if {
    ...
    violations[{"msg": "The volume 'volume2' in workload 'invalid-volumes' is not used by any containers.", "details": {}}] with input as fixture.invalid_volumes
}
