...
missing_startup_probe := {
  ...
  "kind": "Deployment",
  "metadata": {
    "name": "app-missing-startup"
  },
  "spec": {
    "selector": {
      "matchLabels": {
        "app": "app-missing-startup"
      }
    },
    "replicas": 1,
    "template": {
...
invalid_probe_ports := {
  ...
  "kind": "Deployment",
  "metadata": {
    "name": "invalid-probe-ports"
  },
  "spec": {
    "selector": {
      "matchLabels": {
        "app": "invalid-probe-ports"
      }
    },
    "replicas": 1,
    "template": {
...
missing_template_labels := {
  ...
  "metadata": {
    ...
    "labels": {
      "app_id": "missing_template_labels"
    }
  },
  "spec": {
    "selector": {
...
missing_selector_labels := {
  ...
  "metadata": {
    ...
    "labels": {
      "app_id": "missing_selector_labels"
    }
  },
  "spec": {
    "template": {
...
invalid_spec_labels := {
  ...
  "metadata": {
    ...
    "labels": {
      "app_id": "invalid_selector_labels"
    }
  },
  "spec": {
    "selector": {
