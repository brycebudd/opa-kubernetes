package autoscaling.minreplicas_test

import rego.v1
import data.autoscaling.minreplicas.allow
import data.autoscaling.minreplicas.violations
...
test_should_not_allow_when_minreplicas_greater_than_maxreplicas if {
    ...
    violations[{"details": {"code": "HPA-01", "got": 4, "wanted": "less than or equal to 3"}, "msg": "The HorizontalPodAutoscaler 'invalid-replicas' cannot have 'minReplicas' greater than 'maxReplicas'"}] with input as invalid_replicas
}
